...
func TestTransformAndSendHandlers(t *testing.T) {
	...
	transform_unprocessibleEntityError := testStruct{scenarioName: "transform_unprocessibleEntityError", filePath: "../resources/sourceJson/multipleGraphsInList.json", endpoint: "/transform", expectedStatusCode: 422, expectedResult: "Bad Request: More than 1 concept in smartlogic concept payload which is currently not supported"}
	...
	send_unprocessibleEntityError := testStruct{scenarioName: "send_unprocessibleEntityError", filePath: "../resources/sourceJson/multipleGraphsInList.json", endpoint: "/transform/send", expectedStatusCode: 422, expectedResult: "Bad Request: More than 1 concept in smartlogic concept payload which is currently not supported"}
	...
	send_convertsAndFailsForwardToRw := testStruct{scenarioName: "send_convertsAndFailsForwardToRw", filePath: "../resources/sourceJson/noTmeIds.json", endpoint: "/transform/send", expectedStatusCode: 503, expectedResult: "Delete request returned status: 200"}
