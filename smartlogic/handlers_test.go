...
func TestTransformHandler(t *testing.T) {
	...
	send_convertsAndReturnsPayload := testStruct{scenarioName: "send_convertsAndReturnsPayload", filePath: "../resources/sourceJson/multipleTmeIds.json", endpoint: "/transform/send", expectedStatusCode: 200, expectedResult: "Concordance successfully written to db"}
